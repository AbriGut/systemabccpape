                ...
                <div class="col-sm">
                    <div class="card border-info mb-3 py-2" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" class="btn btn-outline-danger" href="http://example2.com/eliminarproducto.php?id=<?=$y['id']?>">Eliminar</a>
                            <a type="button" class="btn btn-outline-warning" href="http://example2.com/editarproducto.php?id=<?=$y['id']?>">Editar</a>
                        </div>
                    </div>  
                </div>      
            </div>
